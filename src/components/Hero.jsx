...
// const Hero = () => {
//   return (
//     <div id="home" className='border-neutral-900 pb-4 lg:mb-35'>
...
//               <a href="https://github.com/sivaprabhakar" target="_blank" rel="noopener noreferrer" className='text-2xl text-gray-500 hover:text-gray-700'>
//                 <IoLogoGithub />
//               </a>
//               <a href="https://www.linkedin.com/in/sivaprabhakaran-pm-10a00127b/" target="_blank" rel="noopener noreferrer" className='text-2xl text-gray-500 hover:text-gray-700'>
//                 <FaLinkedin />
//               </a>
//               <a href="../assets/projects/Siva Resume.pdf" download className='text-2xl relative lg:-top-1 text-blue-500 hover:text-purple-500 flex items-center no-underline'>
...
const Hero = () => {
  const resumeLink = "https://drive.google.com/file/d/1GravjAbdOMZueb9peJeg-WgBh-769vyC/view";
        ...
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-start'>
            ...
            <div className='flex mt-4 space-x-4 '>
              ...
              <a href={resumeLink} target="_blank" rel="noopener noreferrer" className='text-2xl relative lg:-top-1 text-blue-500 hover:text-purple-500 flex items-center no-underline'>
                <span className='hidden lg:inline-block '>Resume</span>
                <GoDownload className='mr-1' />
              </a>
            </div>
